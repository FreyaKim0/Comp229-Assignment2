...
export class StaticDataSource{
  private books: Book[] =[
    ...
    new Book("4", 'Book 4', 'Author 2', 'Year 4', 'Short Description 4', 10),
    ...
    new Book("11", 'Book 11', 'Author 4', 'Year 11', 'Short Description 11', 10),
    new Book("12", 'Book 12', 'Author 5', 'Year 12', 'Short Description 12', 10),
    new Book("13", 'Book 13', 'Author 5', 'Year 13', 'Short Description 13', 10),
    new Book("14", 'Book 14', 'Author 5', 'Year 14', 'Short Description 14', 10),
