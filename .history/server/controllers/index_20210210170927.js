...
module.exports.processRegisterPage = (req, res, next) => {
    ...
    User.register(newUser, req.body.password, (err) => {
        if(err)
        {
            ...
            {
                return res.json({success: false, msg: 'This user already exsist', user: {
                    id: user._id,
            ...
            {
                return res.json({success: false, msg: 'User is not duplicate but the registration process failed ...', user: {
                    id: user._id,
                    password: user.password,
                    displayName: user.displayName,
                    email: user.email
