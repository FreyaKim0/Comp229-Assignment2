...
module.exports.processAddPage = (req, res, next) => {
  ...
  let _id = book_data.lines[0]._id;
  let name = book_data.lines[0].name;
  let author = book_data.lines[0].author;
  let published = book_data.lines[0].published;
  let description = book_data.lines[0].description;
  let price = book_data.lines[0].price;
  let store = book_data.lines[0].store;
  let originalPrice = book_data.lines[0].originalPrice;
  let __v = book_data.lines[0].__v;
