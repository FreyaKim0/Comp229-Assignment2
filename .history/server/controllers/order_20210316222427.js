...
module.exports.processAddPage = (req, res, next) => {
  ...
  let book_data = req.body.order.Cart;

  let book = new Book(
    book_data.lines[0].book._id,
    book_data.lines[0].book.name,
    book_data.lines[0].book.author,
    book_data.lines[0].book.published,
    book_data.lines[0].book.description,
    book_data.lines[0].book.price,
    book_data.lines[0].book.store,
    book_data.lines[0].book.__v,
    book_data.lines[0].book.originalPrice
  );

  let quantity = req.body.cart.lines[0].quantity;
