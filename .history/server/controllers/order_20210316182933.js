...
module.exports.processAddPage = (req, res, next) => {
  ...
  let book = new Book(
    book_data.lines[0]._id,
    book_data.lines[0].name,
    book_data.lines[0].author,
    book_data.lines[0].published,
    book_data.lines[0].description,
    book_data.lines[0].price,
    book_data.lines[0].store,
    book_data.lines[0].originalPrice,
    book_data.lines[0].__v
  );
