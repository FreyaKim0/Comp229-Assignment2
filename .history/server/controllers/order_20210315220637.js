...
module.exports.processAddPage = (req, res, next) => {
  ...
  let book = new Book(
    req.body.cart.lines.book[0]._id,
    req.body.cart.lines.book[0].name,
    req.body.cart.lines.book[0].author,
    req.body.cart.lines.book[0].published,
    req.body.cart.lines.book[0].description,
    req.body.cart.lines.book[0].price,
    req.body.cart.lines.book[0].store,
    req.body.cart.lines.book[0].__v,
    req.body.cart.lines.book[0].originalPrice
  );
