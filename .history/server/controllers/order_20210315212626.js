...
module.exports.processAddPage = (req, res, next) => {
  ...
  let book = new Book(
    req.body.cart.lines.book._id,
    req.body.cart.lines.book.name,
    req.body.cart.lines.author,
    req.body.cart.lines.published,
    req.body.cart.lines.description,
    req.body.cart.lines.price,
    req.body.cart.lines.store,
    req.body.cart.lines.__v,
    req.body.cart.lines.originalPrice
  );
