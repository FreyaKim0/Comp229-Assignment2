...
class RegisterComponent {
    ...
    register(form) {
        ...
        if (form.valid) {
            ...
            this.auth.create(this.user).subscribe(data => {
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 41, vars: 5, consts: [["id", "background"], ["id", "placeholder"], [1, "limiter"], [1, "main_wrap"], ["id", "block_wrap"], ["autocomplete", "off", 3, "ngSubmit"], ["form", "ngForm"], [1, "account_login"], [1, "field_name"], ["data-validate", "Username is required", 1, "wrap-input100", "validate-input", "m-b-36"], ["type", "text", "name", "username", "id", "username", "required", "", "autofocus", "", 1, "input100", 3, "ngModel", "ngModelChange"], [1, "focus-input100"], ["data-validate", "Password is required", 1, "wrap-input100", "validate-input", "m-b-12"], [1, "btn-show-pass"], [1, "fa", "fa-eye"], ["type", "password", "name", "password", "id", "password", "required", "", 1, "input100", 3, "ngModel", "ngModelChange"], ["data-validate", "Email is required", 1, "wrap-input100", "validate-input", "m-b-36"], ["type", "text", "name", "email", "id", "email", "required", "", 1, "input100", 3, "ngModel", "ngModelChange"], ["data-validate", "Display name is required", 1, "wrap-input100", "validate-input", "m-b-36"], ["type", "text", "name", "displayName", "id", "displayName", "required", "", 1, "input100", 3, "ngModel", "ngModelChange"], [1, "container-login100-form-btn"], [1, "login100-form-btn", 3, "disabled"], ["href", "/"], ["type", "button", "value", "Cancel", 1, "login100-form-btn"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
