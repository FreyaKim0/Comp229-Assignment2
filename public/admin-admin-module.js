...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 42, vars: 6, consts: [["id", "background"], ["id", "placeholder"], [1, "limiter"], [1, "main_wrap"], ["id", "block_wrap"], ["autocomplete", "off", 3, "ngSubmit"], ["form", "ngForm"], [1, "account_login"], ["style", "padding-left:20px; font-size:14px; color:red;", 4, "ngIf"], [1, "field_name"], ["data-validate", "Username is required", 1, "wrap-input100", "validate-input", "m-b-36"], ["type", "text", "name", "username", "id", "username", "required", "", "autofocus", "", 1, "input100", 3, "ngModel", "ngModelChange"], [1, "focus-input100"], ["data-validate", "Password is required", 1, "wrap-input100", "validate-input", "m-b-12"], [1, "btn-show-pass"], [1, "fa", "fa-eye"], ["type", "password", "name", "password", "id", "password", "required", "", 1, "input100", 3, "ngModel", "ngModelChange"], ["data-validate", "Email is required", 1, "wrap-input100", "validate-input", "m-b-36"], ["type", "text", "name", "email", "id", "email", "required", "", 1, "input100", 3, "ngModel", "ngModelChange"], ["data-validate", "Display name is required", 1, "wrap-input100", "validate-input", "m-b-36"], ["type", "text", "name", "displayName", "id", "displayName", "required", "", 1, "input100", 3, "ngModel", "ngModelChange"], [1, "container-login100-form-btn"], [1, "login100-form-btn", 3, "disabled"], ["href", "/"], ["type", "button", "value", "Cancel", 1, "login100-form-btn"], [2, "padding-left", "20px", "font-size", "14px", "color", "red"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
